...
public class SendMail {
    ...
    public static String myEmailAccount = "784304900@qq.com";
    public static String myEmailPassword = "ilezbdnptstcbcad";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "东尼大木", "UTF-8"));
